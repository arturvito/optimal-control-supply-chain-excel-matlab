...
This repository contains the computational files associated with the SBPO 2026 paper:
...
# Controle Ótimo de Cadeias de Suprimentos

Este repositório contém os arquivos computacionais associados ao artigo do SBPO 2026:
